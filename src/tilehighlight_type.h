...
struct TileHighlightData {
	...
	uint num_tracks;     ///< Number of highlighted tracks in multi-track highlight (#HT_LINE).
	...
	uint new_num_tracks; ///< New value for \a num_tracks; used to determine whether to redraw the selection.
